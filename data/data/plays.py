...
WALK_RBI = "walk_rbi"
INTENTIONAL_WALK_RBI = "intent_walk_rbi"
...
DOUBLE_PLAY_RBI = "double_play_rbi"
DOUBLE_PLAY_ALT_RBI = "grounded_into_double_play_rbi"

HITS = [SINGLE, DOUBLE, TRIPLE, SINGLE_RBI, DOUBLE_RBI, TRIPLE_RBI, HOME_RUN, HOME_RUN_2, HOME_RUN_3, HOME_RUN_4, SACRIFICE_BUNT, SACRIFICE_FLY,  SACRIFICE_BUNT_RBI, SACRIFICE_FLY_RBI, ERROR, FIELDERS_CHOICE, FIELD_OUT, FIELD_OUT_FLY, FIELD_OUT_LINE, FIELD_OUT_GROUND, FIELD_OUT_POP, FIELD_OUT_FLY_RBI, FIELD_OUT_LINE_RBI, FIELD_OUT_GROUND_RBI, FIELD_OUT_POP_RBI, FIELD_OUT_RBI, DOUBLE_PLAY, DOUBLE_PLAY_ALT]

WALKS = [WALK, INTENTIONAL_WALK, HIT_BY_PITCH, STOLEN_BASE_2B, STOLEN_BASE_3B, STOLEN_BASE_HOME, WALK_RBI, INTENTIONAL_WALK_RBI, HIT_BY_PITCH_RBI]

OUTS = [FIELD_OUT, FIELD_OUT_FLY, FIELD_OUT_LINE, FIELD_OUT_GROUND, FIELD_OUT_POP, DOUBLE_PLAY, DOUBLE_PLAY_ALT, FIELDERS_CHOICE]

STRIKEOUTS = [STRIKEOUT, STRIKEOUT_ALT, STRIKEOUT_LOOKING]

SCORING = [HOME_RUN, HOME_RUN_2, HOME_RUN_3, HOME_RUN_4, SINGLE_RBI, DOUBLE_RBI, TRIPLE_RBI, STOLEN_BASE_HOME, INTENTIONAL_WALK_RBI, WALK_RBI, HIT_BY_PITCH_RBI, SACRIFICE_FLY, SACRIFICE_FLY_RBI, SACRIFICE_BUNT_RBI, FIELD_OUT_FLY_RBI, FIELD_OUT_LINE_RBI, FIELD_OUT_GROUND_RBI, FIELD_OUT_POP_RBI, FIELD_OUT_RBI, DOUBLE_PLAY_RBI, DOUBLE_PLAY_ALT_RBI]
...
PLAY_RESULTS = {
    ...
    INTENTIONAL_WALK_RBI: {"short": "BB", "long": "RBI IWlk"},
    ...
    DOUBLE_PLAY_RBI: {"short": "DP", "long": "RBI DP"},
    DOUBLE_PLAY_ALT_RBI: {"short": "DP", "long": "RBI DP"},
}
